...
<body>
    ...
    <section class="p4 my_container">
        ...
        <div class="container" id="owner">
            <div class="container" style="margin-top: 50px;margin-bottom:20px;width: 100%">
                <form>
                    <a href="addShop.php?func=add" type="submit" class="btn btn-primary btn-sm">Add new Shop</a>
            ...
            <table id="shop_table" class="table table-striped table-light table-bordered" style="width:100%">
        ...
        <script>
            ...
            //             $('#shop_table').html(response)
            //             // $('#shop_table tr').each(function() {
            //             //     var status = $('#status_c').text()
            //             //   var text =  $(this).find('#status_c').html()
            //             //     if(text == 'vacant'){
            //             //         $(this).css('color', 'red')
            //             //     }else{
    ...
    <script>
        // $(document).ready(function() {
        //     console.log($('#my_table tbody').html())
        //     // $('#my_table tbody').each(function(index,value) {
        //     //     console.log($("#status_c").html)
