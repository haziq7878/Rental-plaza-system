...
<body>
    ...
    if (isset($_GET['id'])) {
        $vname = $comp_name = $vemail = $vmobile = $vcnic = "";
        $array = getTenantInfo($_GET['id']);
        $vname = $array['Name'];
        $comp_name = $array['CompanyName'];
        $vemail = $array['Email'];
    ...
    <section class="p4 my_container">
        ...
        <div class="container" id="owner">
            <div class="row justify-content-center shadow p-3 mb-5 bg-white rounded" style="border: 1px solid;border-style:groove">
                <div class="col-mg-6">
                    <h1>Add Tenant</h1>
                    <form action="registerTenant.php?func=<?php echo $_GET['func']; ?><?php if (isset($_GET['id'])) {
                                                                                            echo '&id=' . $_GET['id'];
                                                                                        } ?>" method="POST">
                        <div class="mb-5 mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="compaany_name" placeholder="company Name" name="company_name" value="<?php echo $comp_name ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email:</label>
                            <input type="text" class="form-control" id="email" placeholder="Email" name="email" value="<?php echo $vemail ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="mobile" class="form-label">Mobile:</label>
                            <input type="text" class="form-control" id="mobile" placeholder="Mobile number" name="mobile" value="<?php echo $vmobile ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="CNIC" class="form-label">CNIC:</label>
                            <input type="text" class="form-control" id="CNIC" placeholder="CNIC" name="CNIC" value="<?php echo $vcnic ?>" required>
                        </div>
                        <div>
